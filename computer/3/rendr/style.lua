...
style.root = cpair(colors.black, colors.white)
...
style.ind_yllw = cpair(colors.yellow, colors.yellow_off)
style.ind_wht = cpair(colors.white, colors.gray)

style.gray_white = cpair(colors.lightGray, colors.black)
