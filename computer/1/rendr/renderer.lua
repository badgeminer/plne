...
local ap_win = window.create(mon,1,1,15,24)
...
local renderer   = {}
local a          = {
    ["black"] = 0x111111, ["blue"] = 0x2A7BDE, ["brown"] = 0x571213, ["cyan"] = 0x2AA1B3, ["gray"] = 0x444444,
    ["green"] = 0x26A269, ["lightBlue"] = 0x00AEFF, ["lightGray"] = 0x777777, ["lime"] = 0x16665a, ["magenta"] = 0x85862c,
    ["orange"] = 0xD06018, ["pink"] = 0xF66151, ["purple"] = 0xA347BA, ["red"] = 0xC01C28, ["white"] = 0xFFFFFF,
    ["yellow"] = 0xF3F03E }
local ui         = {
    display = nil,
    ap_display = nil,
...
function renderer.try_start_ui()
    ...
    if ui.display == nil then
        ...
        for b, c in pairs(a) do
            term.setPaletteColor(colors[b], c)
        ...
        status, msg = pcall(function()
            ...
            ui.ap_display = DisplayBox { window = ap_win, fg_bg = cpair(colors.white, colors.black) }
