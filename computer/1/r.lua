...
parallel.waitForAll(main,function()
    databus.ps.toggle('ef1')
    databus.ps.toggle('ef2')
    databus.ps.toggle('mwarn')
    databus.ps.toggle('mcat')
    databus.ps.publish('PA',false)
    databus.ps.publish('AP',false)
    databus.ps.publish('AT',false)
    sleep(1)
    databus.ps.publish('gear',types.GEAR_STATE.LOWERING)
    sleep(1)
    databus.ps.toggle('mwarn')
    databus.ps.publish('ef1',types.ENGN_F_STATE.FIRE)
    databus.ps.publish('ef2',types.ENGN_F_STATE.FIRE)
    databus.ps.publish('gear',types.GEAR_STATE.DOWN)
    sleep(1)
    databus.ps.publish('gear',types.GEAR_STATE.RASING)
    sleep(1)
    databus.ps.toggle('mwarn')
    databus.ps.toggle('mcat')
    databus.ps.publish('gear',types.GEAR_STATE.UP)
    databus.ps.publish('ef1',types.ENGN_F_STATE.EXT)
    databus.ps.publish('ef2',types.ENGN_F_STATE.EXT)
end,function()
    while true do
